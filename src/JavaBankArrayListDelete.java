    ...
    private void createUserInterface() {
        ...
        this.CreateAccountJButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent event) {
                JavaBankArrayListDelete.this.CreateAccountJButtonActionPerformed(event);
            }
        });
        ...
        this.DeleteAccountJButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent event) {
                JavaBankArrayListDelete.this.DeleteAccountJButtonActionPerformed(event);
            }
        });
        ...
        this.TransactionJButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent event) {
                JavaBankArrayListDelete.this.TransactionJButtonActionPerformed(event);
            }
        });
        ...
        this.DisplayJButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent event) {
                JavaBankArrayListDelete.this.DisplayJButtonActionPerformed(event);
            }
        });
